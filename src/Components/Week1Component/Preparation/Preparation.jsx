...
import PreparationVideo from "../../Week1VideoComponents/PreparationVideo/PreparationVideo"
            ...
            <div className=''> 
                ...
                <div className={` absolute top-20 ${open?' md:block hidden' : ' hidden'}`}>
                    <div className="flex justify-start" onClick={()=>setOpen(!open)}>
                        ...
                        >
                            <span className={`overflow-hidden text-nowrap transition-all duration-300 ease-in-out ${isHovered ? 'w-32 opacity-100' : 'w-0 opacity-0'} `}>
                            Syllabus
                            </span>
