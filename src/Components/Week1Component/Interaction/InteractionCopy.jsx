    ...
    <>
        <div className=' max-w-[100%]'>
            <div className=''> 
                ...
                <div className={` absolute top-20 ${open?' hidden' : '  md:block hidden'}`}>
                ...
                <div className={`hidden md:block ${open?' block ':'md:hidden hidden'}`}>
                    <PanelGroup autoSaveId="example" direction="horizontal" className={' '}>
                        ...
                        <PanelResizeHandle withHandle className={`flex items-center h-svh justify-center ${open? 'block' : ' hidden'}`}>
                ...
                <div className={`grid grid-cols-10 ${open?' block md:hidden':' block'}`}>
                    ...
                    <div className={` order-1 md:order-2 ${open?'col-span-10' : 'md:col-span-10 col-span-10'}`}>
                        <IntroductionVideo/>
                        <Tabs defaultValue={1}>
                            <TabsList className=" flex items-center">
                            <Tab value={1} slotProps={{
                            ...
                            <TabPanel value={2}>
                                <div className={`${open?'block' : 'md:block '}`}>
...
export default InteractionCopy 