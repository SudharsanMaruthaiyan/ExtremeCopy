...
// toggle open
const Week2 = ({title ,quizDuration,quizQuesion,quiz, duration  , option1, option2, option3, option4, option5,option6}) => {
                    ...
                    <Link to={"/preparation"}>
                        <div className=' flex items-center w-full justify-between p-5 group bg-[#F9FAFC] border-b-white border-b-2 px-2'>
                            <div className=' flex items-start gap-2'>
                                <Book className='w-5 mt-1 stroke-[#1039C5]'/>
                                <div className=' flex flex-col items-start text-start'>
                                    <p className=' font-bold font-[poppins] group-hover:text-[#6BE69B]'>{option6}</p>
                                    <p>{duration}</p>
                                </div>
                            </div>
                            <div >
